...
path = script_directory + '/../nsnet_1000_400/'
filename = 'output.txt'
...
num_exp : int = len(fc1matmul)
print(sum(fc1matmul) / num_exp)
print(sum(fc2matmul) / num_exp)
print(sum(fc3matmul) / num_exp)
print(sum(fc4matmul) / num_exp)