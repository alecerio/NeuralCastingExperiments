// *****************************************************************************
// 	THIS CODE WAS AUTOMATICALLY GENERATED ON 2024-03-07 15:57:37
// *****************************************************************************
...
void allocnn() {
FILE *fp;
READMAT(tensor_fc1bias, 300, "fc1bias.bin", float32_t)
...
READMAT(tensor_onnxMatMul_164, 77100, "onnxMatMul_164.bin", float32_t)
READMAT(tensor_onnxGRU_182, 270000, "onnxGRU_182.bin", float32_t)
READMAT(tensor_onnxGRU_183, 270000, "onnxGRU_183.bin", float32_t)
READMAT(tensor_onnxGRU_184, 1800, "onnxGRU_184.bin", float32_t)
READMAT(tensor_onnxGRU_202, 270000, "onnxGRU_202.bin", float32_t)
READMAT(tensor_onnxGRU_203, 270000, "onnxGRU_203.bin", float32_t)
READMAT(tensor_onnxGRU_204, 1800, "onnxGRU_204.bin", float32_t)
READMAT(tensor_onnxMatMul_205, 180000, "onnxMatMul_205.bin", float32_t)
...
float32_t tensor_fc1MatMul_output_0[1 * 300];
...
#pragma omp reduction(temp: +)
        for(int32_t k=0; k<257; k++) {
            ...
            int32_t index2 = k*300+j;
            temp += tensor_onnxMatMul_0[index1] * tensor_onnxMatMul_164[index2];
        }
        tensor_fc1MatMul_output_0[i*300 + j] = temp;
    }
}

#ifdef COMPILER_BENCHMARK
BENCHMARK("tensor_fc1MatMul", 814)
#endif
...
for(int i=0; i<1; i++) {
    for(int j=0; j<300; j++) {
        printf("%f, ", tensor_fc1MatMul_output_0[i*300+j]);
    }
    printf("\n");
}
...
#ifdef CONNECTED_OUTPUT
float32_t tensor_fc1Add_output_0[300];
#undef CONNECTED_OUTPUT
#endif
...
tensor_fc1Add_output_0[i1*300 + i2*1] = tensor_fc1bias[i2*1] + tensor_fc1MatMul_output_0[i1*300 + i2*1];
}
}
}
...
#ifdef CONNECTED_OUTPUT
float tensor_gru1Transpose_output_0[300];
#undef CONNECTED_OUTPUT
#endif
...
tensor_gru1Transpose_output_0[i0*(1*300)+i2*(1)] = tensor_fc1Add_output_0[i1*300 + i2*1];
}
}
}
...
#ifdef CONNECTED_OUTPUT
float tensor_gru1GRU_output_0[300];
#undef CONNECTED_OUTPUT
#endif
...
#pragma omp reduction(a: +)
        for(int j=0; j<300; j++) {
            a[i] += tensor_onnxGRU_182[(300*300) + i*300 + j] * tensor_gru1Transpose_output_0[j];
        }
        a[i] += tensor_onnxGRU_184[300 + i];
    }
...
#pragma omp reduction(b: +)
        for(int j=0; j<300; j++) {
            b[i] += tensor_onnxGRU_183[(300*300) + i*300 + j] * tensor_hidden1[j];
        }
        b[i] += tensor_onnxGRU_184[4*300 + i];
    }
...
#pragma omp reduction(c: +)
        for(int j=0; j<300; j++) {
            c[i] += tensor_onnxGRU_182[i*300 + j] * tensor_gru1Transpose_output_0[j];
        }
...
#pragma omp reduction(d: +)
        for(int j=0; j<300; j++) {
            d[i] += tensor_onnxGRU_183[i*300 + j] * tensor_hidden1[j];
        }
        d[i] += tensor_onnxGRU_184[3*300 + i];
    }
...
#pragma omp reduction(e: +)
        for(int j=0; j<300; j++) {
            e[i] += tensor_onnxGRU_182[(2*300*300) + i*300 + j] * tensor_gru1Transpose_output_0[j];
        }
        e[i] += tensor_onnxGRU_184[2*300 + i];
    }
...
#pragma omp reduction(f: +)
        for(int j=0; j<300; j++) {
            f[i] += tensor_onnxGRU_183[(2*300*300) + i*300 + j] * tensor_hidden1[j];
        }
        f[i] += tensor_onnxGRU_184[5*300 + i];
    }
...
#ifdef COMPILER_BENCHMARK
BENCHMARK("tensor_/gru1/GRU", 1088400)
#endif
...
#ifdef CONNECTED_OUTPUT
float tensor_gru2GRU_output_0[300];
#undef CONNECTED_OUTPUT
#endif
...
#pragma omp reduction(a: +)
        for(int j=0; j<300; j++) {
            a[i] += tensor_onnxGRU_202[(300*300) + i*300 + j] * tensor_gru1Squeeze_output_0[j];
        }
        a[i] += tensor_onnxGRU_204[300 + i];
    }
...
#pragma omp reduction(b: +)
        for(int j=0; j<300; j++) {
            b[i] += tensor_onnxGRU_203[(300*300) + i*300 + j] * tensor_hidden[j];
        }
        b[i] += tensor_onnxGRU_204[4*300 + i];
    }
...
#pragma omp reduction(c: +)
        for(int j=0; j<300; j++) {
            c[i] += tensor_onnxGRU_202[i*300 + j] * tensor_gru1Squeeze_output_0[j];
        }
...
#pragma omp reduction(d: +)
        for(int j=0; j<300; j++) {
            d[i] += tensor_onnxGRU_203[i*300 + j] * tensor_hidden[j];
        }
        d[i] += tensor_onnxGRU_204[3*300 + i];
    }
...
#pragma omp reduction(e: +)
        for(int j=0; j<300; j++) {
            e[i] += tensor_onnxGRU_202[(2*300*300) + i*300 + j] * tensor_gru1Squeeze_output_0[j];
        }
        e[i] += tensor_onnxGRU_204[2*300 + i];
    }
...
#pragma omp reduction(f: +)
        for(int j=0; j<300; j++) {
            f[i] += tensor_onnxGRU_203[(2*300*300) + i*300 + j] * tensor_hidden[j];
        }
        f[i] += tensor_onnxGRU_204[5*300 + i];
    }
...
#ifdef COMPILER_BENCHMARK
BENCHMARK("tensor_/gru2/GRU", 1088400)
#endif
...
#ifdef CONNECTED_OUTPUT
float tensor_gru2Transpose_output_0[300];
#undef CONNECTED_OUTPUT
#endif
...
tensor_gru2Transpose_output_0[i0*(1*300)+i2*(1)] = tensor_gru2Squeeze_output_0[i1*300 + i2*1];
}
}
}
...
#ifdef COMPILER_BENCHMARK
BENCHMARK("tensor_fc3MatMul", 1200)
#endif
