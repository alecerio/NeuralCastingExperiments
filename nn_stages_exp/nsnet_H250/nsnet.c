// *****************************************************************************
// 	THIS CODE WAS AUTOMATICALLY GENERATED ON 2024-03-07 15:56:06
// *****************************************************************************
...
void allocnn() {
FILE *fp;
READMAT(tensor_fc1bias, 250, "fc1bias.bin", float32_t)
...
READMAT(tensor_onnxMatMul_164, 64250, "onnxMatMul_164.bin", float32_t)
READMAT(tensor_onnxGRU_182, 187500, "onnxGRU_182.bin", float32_t)
READMAT(tensor_onnxGRU_183, 187500, "onnxGRU_183.bin", float32_t)
READMAT(tensor_onnxGRU_184, 1500, "onnxGRU_184.bin", float32_t)
READMAT(tensor_onnxGRU_202, 187500, "onnxGRU_202.bin", float32_t)
READMAT(tensor_onnxGRU_203, 187500, "onnxGRU_203.bin", float32_t)
READMAT(tensor_onnxGRU_204, 1500, "onnxGRU_204.bin", float32_t)
READMAT(tensor_onnxMatMul_205, 150000, "onnxMatMul_205.bin", float32_t)
...
float32_t tensor_fc1MatMul_output_0[1 * 250];
...
for(int i=0; i<1; i++) {
    for(int j=0; j<250; j++) {
        printf("%f, ", tensor_fc1MatMul_output_0[i*250+j]);
    }
    printf("\n");
}
...
#ifdef CONNECTED_OUTPUT
float32_t tensor_fc1Add_output_0[250];
#undef CONNECTED_OUTPUT
#endif
...
tensor_fc1Add_output_0[i1*250 + i2*1] = tensor_fc1bias[i2*1] + tensor_fc1MatMul_output_0[i1*250 + i2*1];
}
}
}
...
#ifdef CONNECTED_OUTPUT
float tensor_gru1Transpose_output_0[250];
#undef CONNECTED_OUTPUT
#endif
...
tensor_gru1Transpose_output_0[i0*(1*250)+i2*(1)] = tensor_fc1Add_output_0[i1*250 + i2*1];
}
}
}
...
#ifdef CONNECTED_OUTPUT
float tensor_gru1GRU_output_0[250];
#undef CONNECTED_OUTPUT
#endif
...
#pragma omp reduction(a: +)
        for(int j=0; j<250; j++) {
            a[i] += tensor_onnxGRU_182[(250*250) + i*250 + j] * tensor_gru1Transpose_output_0[j];
        }
        a[i] += tensor_onnxGRU_184[250 + i];
    }
...
#pragma omp reduction(b: +)
        for(int j=0; j<250; j++) {
            b[i] += tensor_onnxGRU_183[(250*250) + i*250 + j] * tensor_hidden1[j];
        }
        b[i] += tensor_onnxGRU_184[4*250 + i];
    }
...
#pragma omp reduction(c: +)
        for(int j=0; j<250; j++) {
            c[i] += tensor_onnxGRU_182[i*250 + j] * tensor_gru1Transpose_output_0[j];
        }
...
#pragma omp reduction(d: +)
        for(int j=0; j<250; j++) {
            d[i] += tensor_onnxGRU_183[i*250 + j] * tensor_hidden1[j];
        }
        d[i] += tensor_onnxGRU_184[3*250 + i];
    }
...
#pragma omp reduction(e: +)
        for(int j=0; j<250; j++) {
            e[i] += tensor_onnxGRU_182[(2*250*250) + i*250 + j] * tensor_gru1Transpose_output_0[j];
        }
        e[i] += tensor_onnxGRU_184[2*250 + i];
    }
...
#pragma omp reduction(f: +)
        for(int j=0; j<250; j++) {
            f[i] += tensor_onnxGRU_183[(2*250*250) + i*250 + j] * tensor_hidden1[j];
        }
        f[i] += tensor_onnxGRU_184[5*250 + i];
    }
...
#ifdef CONNECTED_OUTPUT
float tensor_gru2GRU_output_0[250];
#undef CONNECTED_OUTPUT
#endif
...
#pragma omp reduction(a: +)
        for(int j=0; j<250; j++) {
            a[i] += tensor_onnxGRU_202[(250*250) + i*250 + j] * tensor_gru1Squeeze_output_0[j];
        }
        a[i] += tensor_onnxGRU_204[250 + i];
    }
...
#pragma omp reduction(b: +)
        for(int j=0; j<250; j++) {
            b[i] += tensor_onnxGRU_203[(250*250) + i*250 + j] * tensor_hidden[j];
        }
        b[i] += tensor_onnxGRU_204[4*250 + i];
    }
...
#pragma omp reduction(c: +)
        for(int j=0; j<250; j++) {
            c[i] += tensor_onnxGRU_202[i*250 + j] * tensor_gru1Squeeze_output_0[j];
        }
...
#pragma omp reduction(d: +)
        for(int j=0; j<250; j++) {
            d[i] += tensor_onnxGRU_203[i*250 + j] * tensor_hidden[j];
        }
        d[i] += tensor_onnxGRU_204[3*250 + i];
    }
...
#pragma omp reduction(e: +)
        for(int j=0; j<250; j++) {
            e[i] += tensor_onnxGRU_202[(2*250*250) + i*250 + j] * tensor_gru1Squeeze_output_0[j];
        }
        e[i] += tensor_onnxGRU_204[2*250 + i];
    }
...
#pragma omp reduction(f: +)
        for(int j=0; j<250; j++) {
            f[i] += tensor_onnxGRU_203[(2*250*250) + i*250 + j] * tensor_hidden[j];
        }
        f[i] += tensor_onnxGRU_204[5*250 + i];
    }
...
#ifdef CONNECTED_OUTPUT
float tensor_gru2Transpose_output_0[250];
#undef CONNECTED_OUTPUT
#endif
...
tensor_gru2Transpose_output_0[i0*(1*250)+i2*(1)] = tensor_gru2Squeeze_output_0[i1*250 + i2*1];
}
}
}
...
for(int32_t i=0; i<1; i++) {
    for(int32_t j=0; j<600; j++) {
        float32_t temp = 0.0f;
#pragma omp reduction(temp: +)
        for(int32_t k=0; k<250; k++) {
            int32_t index1 = i*250+k;
