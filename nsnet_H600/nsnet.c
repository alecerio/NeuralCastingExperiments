// *****************************************************************************
// 	THIS CODE WAS AUTOMATICALLY GENERATED ON 2024-03-07 16:07:23
// *****************************************************************************
...
void allocnn() {
FILE *fp;
READMAT(tensor_fc1bias, 600, "fc1bias.bin", float32_t)
...
READMAT(tensor_onnxMatMul_164, 154200, "onnxMatMul_164.bin", float32_t)
READMAT(tensor_onnxGRU_182, 1080000, "onnxGRU_182.bin", float32_t)
READMAT(tensor_onnxGRU_183, 1080000, "onnxGRU_183.bin", float32_t)
READMAT(tensor_onnxGRU_184, 3600, "onnxGRU_184.bin", float32_t)
READMAT(tensor_onnxGRU_202, 1080000, "onnxGRU_202.bin", float32_t)
READMAT(tensor_onnxGRU_203, 1080000, "onnxGRU_203.bin", float32_t)
READMAT(tensor_onnxGRU_204, 3600, "onnxGRU_204.bin", float32_t)
READMAT(tensor_onnxMatMul_205, 360000, "onnxMatMul_205.bin", float32_t)
...
float32_t tensor_fc1MatMul_output_0[1 * 600];
...
#pragma omp reduction(temp: +)
        ...
        tensor_fc1MatMul_output_0[i*600 + j] = temp;
    }
}

#ifdef COMPILER_BENCHMARK
BENCHMARK("tensor_fc1MatMul", 1114)
#endif
...
for(int i=0; i<1; i++) {
    for(int j=0; j<600; j++) {
        printf("%f, ", tensor_fc1MatMul_output_0[i*600+j]);
    }
    printf("\n");
}
...
#ifdef CONNECTED_OUTPUT
float32_t tensor_fc1Add_output_0[600];
#undef CONNECTED_OUTPUT
#endif
...
tensor_fc1Add_output_0[i1*600 + i2*1] = tensor_fc1bias[i2*1] + tensor_fc1MatMul_output_0[i1*600 + i2*1];
}
}
}
...
#ifdef CONNECTED_OUTPUT
float tensor_gru1Transpose_output_0[600];
#undef CONNECTED_OUTPUT
#endif
...
tensor_gru1Transpose_output_0[i0*(1*600)+i2*(1)] = tensor_fc1Add_output_0[i1*600 + i2*1];
}
}
}
...
#ifdef CONNECTED_OUTPUT
float tensor_gru1GRU_output_0[600];
#undef CONNECTED_OUTPUT
#endif
...
#pragma omp reduction(a: +)
        for(int j=0; j<600; j++) {
            a[i] += tensor_onnxGRU_182[(600*600) + i*600 + j] * tensor_gru1Transpose_output_0[j];
        }
        a[i] += tensor_onnxGRU_184[600 + i];
    }
...
#pragma omp reduction(b: +)
        for(int j=0; j<600; j++) {
            b[i] += tensor_onnxGRU_183[(600*600) + i*600 + j] * tensor_hidden1[j];
        }
        b[i] += tensor_onnxGRU_184[4*600 + i];
    }
...
#pragma omp reduction(c: +)
        for(int j=0; j<600; j++) {
            c[i] += tensor_onnxGRU_182[i*600 + j] * tensor_gru1Transpose_output_0[j];
        }
...
#pragma omp reduction(d: +)
        for(int j=0; j<600; j++) {
            d[i] += tensor_onnxGRU_183[i*600 + j] * tensor_hidden1[j];
        }
        d[i] += tensor_onnxGRU_184[3*600 + i];
    }
...
#pragma omp reduction(e: +)
        for(int j=0; j<600; j++) {
            e[i] += tensor_onnxGRU_182[(2*600*600) + i*600 + j] * tensor_gru1Transpose_output_0[j];
        }
        e[i] += tensor_onnxGRU_184[2*600 + i];
    }
...
#pragma omp reduction(f: +)
        for(int j=0; j<600; j++) {
            f[i] += tensor_onnxGRU_183[(2*600*600) + i*600 + j] * tensor_hidden1[j];
        }
        f[i] += tensor_onnxGRU_184[5*600 + i];
    }
...
#ifdef COMPILER_BENCHMARK
BENCHMARK("tensor_/gru1/GRU", 4336800)
#endif
...
#ifdef CONNECTED_OUTPUT
float tensor_gru2GRU_output_0[600];
#undef CONNECTED_OUTPUT
#endif
...
#pragma omp reduction(a: +)
        for(int j=0; j<600; j++) {
            a[i] += tensor_onnxGRU_202[(600*600) + i*600 + j] * tensor_gru1Squeeze_output_0[j];
        }
        a[i] += tensor_onnxGRU_204[600 + i];
    }
...
#pragma omp reduction(b: +)
        for(int j=0; j<600; j++) {
            b[i] += tensor_onnxGRU_203[(600*600) + i*600 + j] * tensor_hidden[j];
        }
        b[i] += tensor_onnxGRU_204[4*600 + i];
    }
...
#pragma omp reduction(c: +)
        for(int j=0; j<600; j++) {
            c[i] += tensor_onnxGRU_202[i*600 + j] * tensor_gru1Squeeze_output_0[j];
        }
...
#pragma omp reduction(d: +)
        for(int j=0; j<600; j++) {
            d[i] += tensor_onnxGRU_203[i*600 + j] * tensor_hidden[j];
        }
        d[i] += tensor_onnxGRU_204[3*600 + i];
    }
...
#pragma omp reduction(e: +)
        for(int j=0; j<600; j++) {
            e[i] += tensor_onnxGRU_202[(2*600*600) + i*600 + j] * tensor_gru1Squeeze_output_0[j];
        }
        e[i] += tensor_onnxGRU_204[2*600 + i];
    }
...
#pragma omp reduction(f: +)
        for(int j=0; j<600; j++) {
            f[i] += tensor_onnxGRU_203[(2*600*600) + i*600 + j] * tensor_hidden[j];
        }
        f[i] += tensor_onnxGRU_204[5*600 + i];
    }
...
#ifdef COMPILER_BENCHMARK
BENCHMARK("tensor_/gru2/GRU", 4336800)
#endif
...
#ifdef CONNECTED_OUTPUT
float tensor_gru2Transpose_output_0[600];
#undef CONNECTED_OUTPUT
#endif
...
tensor_gru2Transpose_output_0[i0*(1*600)+i2*(1)] = tensor_gru2Squeeze_output_0[i1*600 + i2*1];
}
}
}
...
#ifdef COMPILER_BENCHMARK
BENCHMARK("tensor_fc3MatMul", 1800)
#endif
